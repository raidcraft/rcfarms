 ...
 * @author Philip Urban
 */
public class AllowAllMaterialsAnswer extends ConfiguredAnswer {

    public AllowAllMaterialsAnswer(String type, ConfigurationSection config) {
    ...
    public boolean processInput(Conversation conversation, String input) {
        ...
        ((FarmConversation) conversation).setAllowAllMaterials(true);
        return true;
    }
}
